      ...
      <div className="bg-[#D72638] py-6 px-6 md:px-12 lg:px-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            className="bg-white text-[#D72638] font-black text-sm px-6 py-3 rounded-full hover:bg-[#F5C800] hover:text-[#1A1A1A] transition-colors duration-200 flex items-center gap-2"
          >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-14">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 text-white/45 text-sm font-medium">
                <li>contacto@pbg.com</li>
                <li>+57 300 000 0000</li>
                <li>Calle 10 #22-15, Local 3</li>
                <li className="pt-2">
                  <a href={WA_LINK} target="_blank" rel="noopener noreferrer"
                    className="text-[#F5C800] font-bold hover:text-white transition-colors duration-200 flex items-center gap-2">
                    <span className="text-[#25D366]">●</span> WhatsApp Activo
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div className="flex gap-6">
              {['Privacidad', 'Términos', 'Transparencia'].map(t => (
                <a key={t} href="#" className="text-white/30 text-xs font-medium hover:text-white/60 transition-colors duration-200">
                  {t}
                </a>
              ))}
            </div>
